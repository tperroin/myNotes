...
@section('navigation')
        ...
        @if(Auth::user())
        @isGranted('admin')
        <div class="ui secondary pointing red vertical menu">
            <div class="item">
                <a href="{{ URL::to('admin') }}">
    ...
    @section('content')
        ...
        <h1>Editer la classe : {{$classroom->code}}</h1>

        <!-- if there are creation errors, they will show here -->
        {{ HTML::ul($errors->all()) }}

        {{ Form::model($classroom, array('route' => array('admin.classrooms.update', $classroom->id), 'method' => 'PUT', 'class' => 'ui form')) }}
                ...
                {{ Form::select('curriculum', $curriculums , Input::old('curriculum')) }}
